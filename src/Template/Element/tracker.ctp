<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 179.73 413.5" id="video_tracker">
  ...
  <g class="cls-1">
    <g id="_1" data-name="1">
      ...
      <text id="c_part1_t" class="circle_text" onclick="app.video_jump(this);" data-time="<?=$video->time1 ?: 0 ?>" ><?=$video->name1 ?: "" ?></text>
      <circle id="c_part4" data-name="№4 Ellipse" class="cls-12 time_point" cx="32.25" cy="306.25" r="8.13"/>
      <text id="c_part2_t" class="circle_text" onclick="app.video_jump(this);" data-time="<?=$video->time2 ?: 0 ?>" ><?=$video->name2 ?: "" ?></text>      
      <circle id="c_part3" data-name="№3 Ellipse" class="cls-13 time_point" cx="12.25" cy="206.69" r="8.13"/>
      <text id="c_part3_t" class="circle_text" onclick="app.video_jump(this);" data-time="<?=$video->time3 ?: 0 ?>" ><?=$video->name3 ?: "" ?></text>            
      ...
      <text id="c_part4_t" class="circle_text" onclick="app.video_jump(this);" data-time="<?=$video->time4 ?: 0 ?>" ><?=$video->name4 ?: "" ?></text>                  
      <circle id="c_part1" data-name="№1 Ellipse" class="cls-12 time_point" cx="52.25" cy="8.13" r="8.13"/>
      <text id="c_part5_t" class="circle_text" onclick="app.video_jump(this);" data-time="<?=$video->time5 ?: 0 ?>" ><?=$video->name5 ?: "" ?></text>
    </g>
  </g>
</svg>
