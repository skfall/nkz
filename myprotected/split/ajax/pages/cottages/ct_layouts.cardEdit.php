...
свойство*значение;' ) ),
					 ...
					 'Изображения'	=>	array( 'type'=>'image_mult', 'field'=>'layouts', 		'params'=>array( 'path'=>RSF."/split/files/cottages/", 'appTable'=>$appTable, 'id'=>$item_id, 'field'=>'filename' ) ),

					 
					 );

	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editUpdCottage", 'ajaxFolder'=>'edit', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Форма редактирования коттеджа #$item_id</h3>";
