<?php 
	...
	$itemsList = $zh->getThLayouts($params);

	$totalItems = $zh->getThLayouts($params,true);
	...
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Таунхаусу'=>'block_name'),
	...
	$tableColumns = array(
						  ...
						  'Название планировки'			=>	array('type'=>'text',		'field'=>'layout_name'),
						  'Название таунхауса'			=>	array('type'=>'text',		'field'=>'block_name'),
						  'Этаж'				=>	array('type'=>'text',		'field'=>'floor_name'),
						  'Участие в акции'				=>	array('type'=>'text',		'field'=>'event_name'),
