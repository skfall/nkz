<?php 
	...
	$itemsList = $zh->getHomeEnvItems($params);

	$totalItems = $zh->getHomeEnvItems($params,true);
	...
	$tableColumns = array(
						  ...
						  'Название таба'			=>	array('type'=>'text',		'field'=>'parent_name'),
						  'Очередность вывода'			=>	array('type'=>'text',		'field'=>'order_id'),
