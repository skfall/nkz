<?php 
	...
	$itemsList = $zh->getFlats($params);

	$totalItems = $zh->getFlats($params,true);
	...
	$tableColumns = array(
						  ...
						  'Дом'					=>	array('type'=>'text',		'field'=>'house_name'),
						  'Количество комнат'	=>	array('type'=>'text',		'field'=>'room_name'),
						  'Общий метраж (м)'	=>	array('type'=>'text',		'field'=>'total_area'),
						  'Публикация'			=>	array('type'=>'block',		'field'=>'block'),
						  'Участие в акции'		=>	array('type'=>'block',		'field'=>'event_id', 'params'=>array('reverse'=>true)),
