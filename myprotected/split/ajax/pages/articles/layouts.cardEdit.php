<?php 
	...
	$cardTmp = array(
					 ...
					 'Общий метраж (м)'			=>	array( 'type'=>'input', 	'field'=>'total_area', 			'params'=>array( 'size'=>50, 'hold'=>'' ) ),
...
Прихожая*10;' ) ),
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editLayouts", 'ajaxFolder'=>'edit', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Форма редактирования планировок квартиры #$item_id</h3>";
