<?php 
	...
	$cardItem['images'] = $zh->getNewsCatsItem($item_id);

	$cardTmp = array(
					 'ID'						=>	array( 'type'=>'text', 		'field'=>'id', 				'params'=>array() ),
					 'Название'					=>	array( 'type'=>'text', 		'field'=>'name', 		'params'=>array() ),
					 'Алиас'					=>	array( 'type'=>'text', 		'field'=>'alias', 		'params'=>array() ),
					 'Количество новостей'					=>	array( 'type'=>'text', 		'field'=>'count_news', 		'params'=>array() ),
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3>Детальный просмотр рубрики новостей #$item_id</h3>";
