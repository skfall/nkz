<?php 
	...
	// GET PAGE DATA
	$cardData = $zh->getThInfo1Page($pageTable);
	...
	$itemsList = $zh->getThInfo1Items($params);
	$totalItems = $zh->getThInfo1Items($params,true);
	...
	$data['bodyContent'] .= "
		<div id='landCluster' class='animatedX'>
			<h3 class='new-line'>Редактирование секции</h3>
	";
		...
		$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editInfoBlock1Page", 'ajaxFolder'=>'edit', 'appTable'=>$pageTable );
