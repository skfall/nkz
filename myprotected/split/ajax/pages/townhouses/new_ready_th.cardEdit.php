<?php 
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editNewReadyTh", 'ajaxFolder'=>'edit', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Форма редактирования READY TOWNHOUSES #$item_id</h3>";
