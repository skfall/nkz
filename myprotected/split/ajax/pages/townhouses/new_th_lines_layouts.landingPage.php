<?php 
	...
	$itemsList = $zh->getThNewLinesLayoutsItems($params);

	$totalItems = $zh->getThNewLinesLayoutsItems($params,true);
	...
	$tableColumns = array(
						  ...
						  'Название линии'			=>	array('type'=>'text',		'field'=>'block_name'),
						  'Этаж'			=>	array('type'=>'text',		'field'=>'floor'),
						  'Название этажа'			=>	array('type'=>'text',		'field'=>'floor_name'),
