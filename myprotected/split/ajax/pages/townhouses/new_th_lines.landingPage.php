<?php 
	...
	$headParams = array( 'parent'=>$parent, 'alias'=>$alias, 'id'=>$id, 'appTable'=>$appTable, 'type' => 'new_th_lines' );
	
	$data['headContent'] = $zh->getLandingHeader($headParams);
	
	// Get page items
	
	$itemsList = $zh->getThNewLinesItems($params);

	$totalItems = $zh->getThNewLinesItems($params,true);
