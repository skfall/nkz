<?php 
	...
	$itemsList = $zh->getEventRecalls($params);

	$totalItems = $zh->getEventRecalls($params,true);
	...
	$tableColumns = array(
						  ...
						  'Тип акции'			=>	array('type'=>'text',		'field'=>'type_event'),
						  'Название акции'			=>	array('type'=>'text',		'field'=>'name_event'),
						  'ID участника акции'		=>	array('type'=>'text',		'field'=>'layout_id'),
