...
DROP TABLE IF EXISTS `osc_about_page`;
CREATE TABLE IF NOT EXISTS `osc_about_page` (
...
(54, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'ТаунхаусыOLD', 'townhousesOLD', '0', 3, '', 1, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
...
(72, 1, 51, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Баннер', 'home_ban', '', 1, '', 1, '#', '2013-11-15 03:30:00', '2016-11-25 18:00:00', 1),
...
(94, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Таунхаусы', 'townhouses', '0', 3, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(95, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Баннер таунхаусы', 'banner_th', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(96, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Секция \"Экохаусы\"', 'intro', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(97, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Секция \"Видео\"', 'video', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(98, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Секция \"Галерея\"', 'new_th_gal', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(99, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Линии', 'new_th_lines', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(100, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Планировки линий', 'new_th_lines_layouts', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(101, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Секция \"Уютный дом\"', 'new_th_comfortable_home', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(102, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Секция \"Все подведено\"', 'new_th_includes', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(103, 1, 94, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Готовые таунхаусы', 'new_ready_th', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
(104, 1, 51, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Секция \"Баннер\"', 'nh_banner', '0', 0, '', 0, '#', '2017-05-02 16:13:08', '2017-05-02 16:13:08', 0),
...
DROP TABLE IF EXISTS `osc_articles`;
CREATE TABLE IF NOT EXISTS `osc_articles` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Список статей и материалов для сайта';
...
DROP TABLE IF EXISTS `osc_article_comments`;
...
DROP TABLE IF EXISTS `osc_article_images_alts`;
CREATE TABLE IF NOT EXISTS `osc_article_images_alts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_bp_questions`;
CREATE TABLE IF NOT EXISTS `osc_bp_questions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_bp_subscriptions`;
CREATE TABLE IF NOT EXISTS `osc_bp_subscriptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cats` text,
...
--
-- Дамп даних таблиці `osc_bp_subscriptions`
--

INSERT INTO `osc_bp_subscriptions` (`id`, `cats`, `email`, `phone`, `seen`, `created`) VALUES
(34, 'ЖК Vlasna;', 'us4ms@mail.ru', '', 0, '2018-06-25 07:33:31'),
(35, 'ЖК Vlasna;', 'us4ms@mail.ru', '+380 (50) 775-78-69', 0, '2018-07-01 21:31:08'),
(36, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:02'),
(37, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:02'),
(38, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:05'),
(39, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:05'),
(40, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:05'),
(41, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:05'),
(42, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:05'),
(43, 'Дом Шатель;', 'katya_1992.92@mail.ru', '', 0, '2018-07-09 13:38:05');
...
CREATE TABLE IF NOT EXISTS `osc_categories` (
  ...
  `adminMod` int(7) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Список категорий для группирования материалов';
...
DROP TABLE IF EXISTS `osc_contacts_page`;
CREATE TABLE IF NOT EXISTS `osc_contacts_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `details` text,
...
DROP TABLE IF EXISTS `osc_copy_history`;
...
DROP TABLE IF EXISTS `osc_ct_banner`;
CREATE TABLE IF NOT EXISTS `osc_ct_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_ct_equip`;
CREATE TABLE IF NOT EXISTS `osc_ct_equip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `block` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `osc_ct_equip_items`;
CREATE TABLE IF NOT EXISTS `osc_ct_equip_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_ct_gallery`;
CREATE TABLE IF NOT EXISTS `osc_ct_gallery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `block` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `osc_ct_gallery_items`;
CREATE TABLE IF NOT EXISTS `osc_ct_gallery_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `filename` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_ct_genplan`;
CREATE TABLE IF NOT EXISTS `osc_ct_genplan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 3, ''),
(2, 3, ''),
(3, 2, 'Дом построен. Площадь дома 80,0 кв.м. Стоимость дома с участком 3,5 сотки составляет $70.000.'),
(4, 3, 'Дом построен. Площадь дома 80,0 кв.м. Стоимость дома с участком 2,7 сотки составляет $50.000.'),
(5, 2, 'Дом построен. Площадь дома 125,0 кв.м. Стоимость дома с участком 2,2 сотки составляет $70.000.'),
...
(22, 3, 'Участок 2,8 сотки под застройку. Стоимость участка $15000'),
(23, 3, ''),
(24, 3, ''),
(25, 3, ''),
(26, 2, 'Дом построен. Площадь дома 80,0 кв.м. Стоимость дома с участком 2,3 сотки составляет $53.000.'),
(27, 3, ''),
(28, 2, 'Дом построен. Площадь дома 200,3 кв.м. Стоимость дома с участком 4,3 сотки составляет $138.000'),
(29, 2, 'Дом построен. Площадь дома 200,3 кв.м. Стоимость дома с участком 4,1 сотки составляет $138.000'),
(30, 2, 'Дом построен. Площадь дома 200,3 кв.м. Стоимость дома с участком 5,1 сотки составляет $138.000'),
(31, 1, 'Участок под застройку, цена 20000 уе'),
(32, 3, 'Участок под застройку, цена 20000 уе'),
(33, 3, 'Участок под застройку, цена 18000 уе'),
(34, 2, 'В наличии. Дом построен. Площадь дома 125,0 кв.м. Стоимость дома с участком 1,9 сотки составляет $70.000.');
...
DROP TABLE IF EXISTS `osc_ct_genplan_statuses`;
CREATE TABLE IF NOT EXISTS `osc_ct_genplan_statuses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_ct_reasons`;
CREATE TABLE IF NOT EXISTS `osc_ct_reasons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `details` text,
  `filename` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_db_structure`;
...
DROP TABLE IF EXISTS `osc_docs_files`;
CREATE TABLE IF NOT EXISTS `osc_docs_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_docs_ref`;
...
DROP TABLE IF EXISTS `osc_event_recall`;
CREATE TABLE IF NOT EXISTS `osc_event_recall` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_files_ref`;
...
DROP TABLE IF EXISTS `osc_forgot_password_hash`;
CREATE TABLE IF NOT EXISTS `osc_forgot_password_hash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dateCreate` datetime NOT NULL,
...
DROP TABLE IF EXISTS `osc_galleries`;
CREATE TABLE IF NOT EXISTS `osc_galleries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `osc_home_ban`;
CREATE TABLE IF NOT EXISTS `osc_home_ban` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_home_common`;
CREATE TABLE IF NOT EXISTS `osc_home_common` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `nh_lat` float NOT NULL DEFAULT '0',
  `nh_lng` float NOT NULL DEFAULT '0',
  `genplan` varchar(255) DEFAULT NULL,
  `meta_title` varchar(255) DEFAULT NULL,
  `meta_keys` varchar(255) DEFAULT NULL,
  `meta_desc` text,
...
INSERT INTO `osc_home_common` (`id`, `transport_capt`, `transport_text`, `infr_capt`, `env_capt`, `bett_capt`, `nh_lat`, `nh_lng`, `genplan`, `meta_title`, `meta_keys`, `meta_desc`) VALUES
(1, 'До Киева <span class=\'green\'>без пробок</span> по трассе европейского уровня', 'Ежедневно ходят маршрутки от метро Выдубичи до \"Новой Конча-Заспы\" каждые 20 мин с 6:00 до 23:00', 'Идеальное место для досуга и отдыха', 'Рядом все, что необходимо', 'Рядом все, что необходимо', 50.2724, 30.5314, 'nhgp_20180618181519169.jpg', NULL, NULL, NULL);
...
DROP TABLE IF EXISTS `osc_home_dev`;
CREATE TABLE IF NOT EXISTS `osc_home_dev` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `details` text,
  `stat` text,
...
(1, 'Застройщик AVM DEVELOPMENT GROUP', '<p>Миссия нашей компании - мы реализуем мечты людей о желаемом качестве жизни, создавая и воплощая пространство, где на высшем уровне решены вопросы комфорта, безопасности и надежности.</p>\r\n', '3 комплекса*строится;\r\n5 комплексов*введено в эксплуатацию;\r\n36 га*площадь застройки;\r\n520 квартир*на стадии строительства;\r\n40 000 м2*сдано в эксплуатацию;\r\n5 лет*на рынке;', 0, '2018-01-01 00:00:00', '2018-07-02 16:50:15');
...
DROP TABLE IF EXISTS `osc_home_env`;
CREATE TABLE IF NOT EXISTS `osc_home_env` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_home_env_items`;
CREATE TABLE IF NOT EXISTS `osc_home_env_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(21, 10, 'Гольф Клуб Козин (Козин)', 2, 15, '15 минут на машине', 0, '2018-01-19 16:55:24', '2018-07-02 16:31:20'),
...
(23, 10, 'Sport Life QUEEN COUNTRY (улица Обуховское шоссе, 55, Козин)', 4, 15, '10 минут на машине', 0, '2018-01-19 16:58:00', '2018-07-02 16:33:02'),
(24, 11, 'Мототрек Пирогово (улица Краснознаменная, 188, Киев)', 1, 10, '10 минут на машине', 0, '2018-01-19 16:59:05', '2018-01-22 10:47:25'),
(25, 11, 'Конный клуб Equides Club (ул. Чапаева, 36, Лесники)', 2, 10, '10 минут на машине', 0, '2018-01-19 16:59:56', '2018-07-02 16:37:06'),
...
(27, 10, 'Фитнес-клуб \"Дельтаплан\" (Новообуховское шоссе, 1)', 4, 10, '2 минуты на машине', 0, '2018-07-04 13:20:03', '2018-07-04 13:23:08');
...
DROP TABLE IF EXISTS `osc_home_gal`;
CREATE TABLE IF NOT EXISTS `osc_home_gal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `features` text,
...
(10, 'Малоэтажная застройка', '', 'hmgl_20180702164216490.jpg', 1, 1, 0, '2018-01-11 19:40:58', '2018-07-02 16:42:28'),
(11, 'Авторские детские площадки', 'скандинавский стиль;\r\nтолько натуральные материалы;', 'hmgl_20180117223954899.jpg', 2, 1, 0, '2018-01-11 19:41:33', '2018-07-02 16:38:39'),
(12, 'Всегда свободная трасса', '', 'hmgl_20180704131743606.jpg', 3, 1, 0, '2018-01-11 19:42:01', '2018-07-04 13:17:43'),
(13, 'Интерьерное решение подъездов', '', 'hmgl_20180122212158808.jpg', 4, 1, 0, '2018-01-11 19:42:49', '2018-01-22 21:23:17'),
(14, 'Новые возможности для каждого', '', 'hmgl_20180704131823334.jpg', 5, 1, 0, '2018-01-12 12:01:59', '2018-07-04 13:18:23');
...
DROP TABLE IF EXISTS `osc_home_infrasctucture`;
CREATE TABLE IF NOT EXISTS `osc_home_infrasctucture` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_home_infrasctucture_items`;
CREATE TABLE IF NOT EXISTS `osc_home_infrasctucture_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_income_questions`;
CREATE TABLE IF NOT EXISTS `osc_income_questions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(249, '2018-06-12 17:54:24', 1, 'Admin login: Success login.', 1, '217.147.174.55'),
(250, '2018-06-13 16:34:13', 1, 'Admin login: Success login.', 1, '217.147.174.55'),
(251, '2018-06-14 13:58:58', 1, 'Admin login: Success login.', 1, '95.158.43.196'),
(252, '2018-06-15 15:25:59', 1, 'Admin login: Success login.', 1, '217.147.174.55'),
(253, '2018-06-18 14:11:21', 1, 'Admin login: Success login.', 1, '217.147.174.55'),
(254, '2018-06-19 18:00:03', 1, 'Admin login: Success login.', 2, '213.159.242.223'),
(255, '2018-06-21 11:40:19', 1, 'Admin login: Success login.', 2, '213.159.247.40'),
(256, '2018-06-21 11:45:53', 1, 'Admin login: Success login.', 2, '213.159.242.223'),
(257, '2018-06-21 12:42:58', 1, 'Admin login: Success login.', 1, '95.158.43.196'),
...
(11, 1, 0, 'Коммерция', 'news/94', 0, 0, 0, 0, 0, 0, 0, '2017-12-28 00:00:00', '2017-12-28 00:00:00', 0);
...
DROP TABLE IF EXISTS `osc_menu_home`;
CREATE TABLE IF NOT EXISTS `osc_menu_home` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `block` int(1) NOT NULL DEFAULT '0',
  `order_id` int(11) NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Список секций на главной';
...
DROP TABLE IF EXISTS `osc_menu_pages_ref`;
CREATE TABLE IF NOT EXISTS `osc_menu_pages_ref` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menu_id` int(11) NOT NULL,
  `table_name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='Связующая таблица меню и страниц';
...
DROP TABLE IF EXISTS `osc_meta_table`;
CREATE TABLE IF NOT EXISTS `osc_meta_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `alias` varchar(255) DEFAULT NULL,
  `meta_title` varchar(255) DEFAULT NULL,
  `meta_keys` varchar(255) DEFAULT NULL,
...
--
-- Структура таблиці `osc_nct_ready_ct`
--

DROP TABLE IF EXISTS `osc_nct_ready_ct`;
CREATE TABLE IF NOT EXISTS `osc_nct_ready_ct` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nct_ready_ct`
--

INSERT INTO `osc_nct_ready_ct` (`id`, `name`, `area`, `block`, `content`, `created`, `modified`) VALUES
(9, 'Двухэтажный дуплекс с мансардой', 125, 0, 'Общая площадь дома 125 кв.м., отлично подойдет как для летнего проживания так и для жизни целый год. Вход в дом с двух сторон. Возле центрального входа есть небольшая террасса. \r\nВ доме три отдельных спальни 20, 16 и 10 кв.м., правильной формы, с большими окнами. Два санузла по 4,6 и 3 кв.м. Кухня объединена с гостиной, можно поставить обеденный стол, всю бытовую технику, телевизор, организовать камин. Есть небольшая гардеробная. Вход в дом с двух сторон. Земля в собственности, участок 2 сотки, огорожен. \r\nДом из красного кирпича, кладка 1,5 кирпича, на ленточном фундаменте с цоколем. Дополнительно утеплен, окна двухкамерные. Сделана разводка под воду и отопление. Крыша из металлочерепицы. На полу стяжка. Большая экономия на коммунальных, т.к. уже стоят счетчики на газ и воду. \r\nКоттедж находится в 3 км от Мегамаркета, на холмах Ходосеевки, на ул. Кобзаря. Рядом ТРЦ «Мануфактура», много загородных ресторанов и кафе, пляжи Голубых озер, Мегамаркет. Потрясающие виды из окон, т.к. коттедж стоит на горе.\r\nСтоимость 68000 уе, можно частями в рассрочку.', '2018-06-25 11:34:47', '2018-07-02 10:52:37'),
(10, 'Двухэтажный коттедж европейского формата', 200, 0, 'Общая площадь дома 200 кв.м. Очень удачная планировка – три просторных и светлых комнаты-спальни 22, 15 и 12 кв.м., все с окнами. При входе в дом большая гостиная совмещенная с кухней, площадь 30 кв.м. Легко помещается вся бытовая техника, можно поставить обеденный стол, небольшую барную стойку, установить камин. Два санузла по 4,6 м. Вход в дом с двух сторон. Земля в собственности, участок 5 соток, огорожен. \r\nДом из красного кирпича, кладка 1,5 кирпича, на ленточном фундаменте с цоколем. Дополнительно утеплен, окна двухкамерные. Сделана разводка под воду и отопление. Крыша из металлочерепицы. На полу стяжка. Дом из натурального красного кирпича М-100 + наружное утепление – зимой тепло, а летом прохладно. Большая экономия на коммунальных, т.к. уже стоят счетчики на газ и воду. \r\nКоттедж находится в 3 км от Мегамаркета, на холмах Ходосеевки, на ул. Кобзаря. Рядом ТРЦ «Мануфактура», много загородных ресторанов и кафе, пляжи Голубых озер, Мегамаркет. Часть комплекса уже заселена. Потрясающие виды из окон, т.к. коттедж стоит на горе.\r\nСтоимость 138 000 уе, можно частями в рассрочку.', '2018-06-25 12:27:47', '2018-07-02 10:51:52'),
(11, 'Небольшой двухэтажный коттедж', 80, 0, 'Дом двухэтажный, общая площадь дома 80 кв.м., отлично подойдет как для летнего проживания так и для жизни целый год. Вход в дом с двух сторон. Возле центрального входа есть небольшая терраса. \r\nВ доме две отдельных спальни 12 и 13 кв.м., правильной формы, с большими окнами. Два санузла по 4,6 и 1,2 кв.м. Кухня объединена с гостиной, можно поставить обеденный стол, всю бытовую технику, телевизор, организовать камин. Есть небольшая гардеробная. Земля в собственности, участок 3 сотки, огорожен. \r\nДом из красного кирпича, кладка 1,5 кирпича, на ленточном фундаменте с цоколем. Дополнительно утеплен, окна двухкамерные. Сделана разводка под воду и отопление. Крыша из металлочерепицы. На полу стяжка. \r\nКоттедж находится в 3 км от Мегамаркета, на холмах Ходосеевки, на ул. Кобзаря. Рядом ТРЦ «Мануфактура», много загородных ресторанов и кафе, пляжи Голубых озер, Мегамаркет. Часть комплекса уже заселена. Потрясающие виды из окон, т.к. коттедж стоит на холме.\r\nСтоимость 70 000 уе, можно частями в рассрочку.', '2018-06-25 12:40:16', '2018-07-01 09:55:07');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nct_ready_ct_layouts`
--

DROP TABLE IF EXISTS `osc_nct_ready_ct_layouts`;
CREATE TABLE IF NOT EXISTS `osc_nct_ready_ct_layouts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` int(11) NOT NULL DEFAULT '0',
  `source` varchar(255) DEFAULT NULL,
  `block` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп даних таблиці `osc_nct_ready_ct_layouts`
--

INSERT INTO `osc_nct_ready_ct_layouts` (`id`, `ref`, `source`, `block`, `created`, `modified`) VALUES
(12, 6, 'thrl_20180623202626276.png', 0, '2018-06-23 20:26:26', '2018-06-23 20:26:26'),
(13, 6, 'thrl_20180623202626901.jpg', 0, '2018-06-23 20:26:26', '2018-06-23 20:26:26'),
(14, 7, 'thrl_20180623202711745.jpg', 0, '2018-06-23 20:27:11', '2018-06-23 20:27:11'),
(15, 7, 'thrl_20180623202711392.jpg', 0, '2018-06-23 20:27:11', '2018-06-23 20:27:11'),
(16, 9, 'thrl_20180625113447465.jpg', 0, '2018-06-25 11:34:47', '2018-06-25 11:34:47'),
(17, 9, 'thrl_20180625113454223.jpg', 0, '2018-06-25 11:34:55', '2018-06-25 11:34:55'),
(18, 10, 'thrl_20180625122747881.jpg', 0, '2018-06-25 12:27:47', '2018-06-25 12:27:47'),
(19, 10, 'thrl_20180625122753531.jpg', 0, '2018-06-25 12:27:53', '2018-06-25 12:27:53'),
(20, 10, 'thrl_20180625122800173.jpg', 0, '2018-06-25 12:28:00', '2018-06-25 12:28:00'),
(21, 11, 'thrl_20180625124016165.jpg', 0, '2018-06-25 12:40:16', '2018-06-25 12:40:16'),
(22, 11, 'thrl_20180625124144756.jpg', 0, '2018-06-25 12:41:44', '2018-06-25 12:41:44');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nh_banner`
--

DROP TABLE IF EXISTS `osc_nh_banner`;
CREATE TABLE IF NOT EXISTS `osc_nh_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nh_banner`
--

INSERT INTO `osc_nh_banner` (`id`, `caption`, `sub_1`, `sub_2`, `pos`, `block`, `source`, `created`, `modified`) VALUES
(1, 'Жилой комплекс \r\n\"Новая Конча-заспа\"', 'квартиры, таунхаусы и коттеджи\r\nв престижном пригороде', '7 км от Киева. Удобная инфраструктура', 0, 0, 'nh_b_20180710152531554.jpg', '2018-06-18 18:14:54', '2018-07-10 15:25:31');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nh_grid`
--

DROP TABLE IF EXISTS `osc_nh_grid`;
CREATE TABLE IF NOT EXISTS `osc_nh_grid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nh_grid`
--

INSERT INTO `osc_nh_grid` (`id`, `caption`, `description`, `source`, `pos`, `block`, `created`, `modified`) VALUES
(1, 'Отличная экология', 'Наш комплекс расположен специально подальше от промзон, чтобы вы могли наслаждаться чистотой и свежестью загородного воздуха. А уникальные Голубые озера и расположенный рядом Голосеевский лес, позволят расслабиться и восстановить свои силы после насыщенны', 'nh_gi_20180618184649187.jpg', 1, 0, '2018-06-18 18:42:24', '2018-06-21 11:55:09'),
(2, 'Готовая инфраструктура', 'В пешей доступности рядом с нами расположено все, что необходимо для комфортной жизни – «Мегамаркет» с большим выбором свежих и качественных продуктов; медицинский центр,  фитнес-клуб, кинотеатр и городок-аутлет «Мануфактура».', 'nh_gi_20180621143608805.jpg', 0, 0, '2018-06-21 14:36:08', '2018-06-21 14:36:08'),
(3, 'Уютное малонаселенное место', 'ЖК «Новая Конча-Заспа» специально расположен в таком месте, чтобы можно было совместить все прелести пригорода и удобства столицы. Обилие зелени, низкая плотность застройки и малоэтажные дома – это гарантия вашего комфорта.', 'nh_gi_20180621143647334.jpg', 0, 0, '2018-06-21 14:36:47', '2018-06-21 14:36:47'),
(4, 'Тишина и свежий воздух', 'Тишина и уют жизни за городом вдохновляет на новые свершения, поэтому мы выбрали место, где можно всегда отдохнуть от суеты большого города.', 'nh_gi_20180621143714215.jpg', 0, 0, '2018-06-21 14:37:14', '2018-06-21 14:37:14'),
(5, 'Аутлет-городок Мануфактура', 'Мощенные улочки, удивительная архитектура, особый шарм и аромат утреннего кофе со свежей выпечкой – это не мечта о старушке Европе, это аутлет-городок «Мануфактура», где каждая деталь имеет значение.', 'nh_gi_20180621143745300.jpg', 0, 0, '2018-06-21 14:37:39', '2018-06-21 14:37:45'),
(6, 'Социальное окружение', 'Наши инвесторы – молодые семейные пары, которые отдают предпочтение работе в динамичном городе, и в то же время уютной и спокойной жизни за его пределами. ', 'nh_gi_20180621143827490.jpg', 0, 0, '2018-06-21 14:38:27', '2018-06-21 14:38:27');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nh_intro`
--

DROP TABLE IF EXISTS `osc_nh_intro`;
CREATE TABLE IF NOT EXISTS `osc_nh_intro` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `content` text,
  `image` varchar(255) DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nh_intro`
--

INSERT INTO `osc_nh_intro` (`id`, `caption`, `content`, `image`, `block`, `created`, `modified`) VALUES
(1, 'Добро пожаловать в Новую Конча-Заспу', '<p>ЖК \"Новая Конча-Заспа\" – это престижный классический пригород, в котором тесно переплетены требования удобной и благополучной жизни: дома построены из красного кирпича, малоэтажная застройка, современная правительственная трасса, чистый воздух, готовая развитая инфраструктура, престижный отдых для всей семьи, успешный социум!<br></p><p>Именно таким требованиям отвечает жилой комплекс «Новая Конча-Заспа», расположенный в ближайшем к Печерску пригороде.<br></p>\r\n', 'nh_intr_20180618182956794.jpg', 0, '2018-06-18 00:00:00', '2018-07-02 16:27:46');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nh_traffic`
--

DROP TABLE IF EXISTS `osc_nh_traffic`;
CREATE TABLE IF NOT EXISTS `osc_nh_traffic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `sub_caption` varchar(255) DEFAULT NULL,
  `description` text,
  ...
  `dest1` varchar(255) DEFAULT NULL,
  `dest2` varchar(255) DEFAULT NULL,
  `dest3` varchar(255) DEFAULT NULL,
  `ob1_lat` float NOT NULL DEFAULT '0',
  `ob1_lng` float NOT NULL DEFAULT '0',
  `ob2_lat` float NOT NULL DEFAULT '0',
  `ob2_lng` float NOT NULL DEFAULT '0',
  `ob3_lat` float NOT NULL DEFAULT '0',
  `ob3_lng` float NOT NULL DEFAULT '0',
  `notification` text,
  `block` int(11) NOT NULL DEFAULT '0',
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nh_traffic`
--

INSERT INTO `osc_nh_traffic` (`id`, `caption`, `sub_caption`, `description`, `time1`, `time2`, `time3`, `dest1`, `dest2`, `dest3`, `ob1_lat`, `ob1_lng`, `ob2_lat`, `ob2_lng`, `ob3_lat`, `ob3_lng`, `notification`, `block`, `created`, `modified`) VALUES
(1, 'ДО КИЕВА БЕЗ ПРОБОК', 'ПО ТРАССЕ ЕВРОПЕЙСКОГО УРОВНЯ', 'Время - самый важный ресурс каждого человека. Мы заботимся о вашем времени - проводите его с пользой, а не стоя в пробках.', 15, 20, 25, 'Выдубичи', 'Теремки', 'Печерская', 50.402, 30.5585, 50.3671, 30.4544, 50.428, 30.539, 'От метро Выдубичи до \"Новой Конча-Заспы\" каждые 20 минут с 6:00 до 23:00', 0, '2018-06-18 00:00:00', '2018-06-21 13:02:04');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_banner`
--

DROP TABLE IF EXISTS `osc_nth_banner`;
CREATE TABLE IF NOT EXISTS `osc_nth_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) DEFAULT NULL,
  `caption` varchar(255) DEFAULT NULL,
  `sub_1` varchar(255) DEFAULT NULL,
...
--
-- Структура таблиці `osc_nth_blocks`
--

DROP TABLE IF EXISTS `osc_nth_blocks`;
CREATE TABLE IF NOT EXISTS `osc_nth_blocks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `type` int(11) NOT NULL DEFAULT '1',
...
--
-- Дамп даних таблиці `osc_nth_blocks`
--
...
--
-- Структура таблиці `osc_nth_blocks_layouts`
--

DROP TABLE IF EXISTS `osc_nth_blocks_layouts`;
CREATE TABLE IF NOT EXISTS `osc_nth_blocks_layouts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп даних таблиці `osc_nth_blocks_layouts`
--

INSERT INTO `osc_nth_blocks_layouts` (`id`, `ref`, `floor`, `floor_name`, `props`, `block`, `created`, `modified`) VALUES
(1, 1, 1, 'Первый этаж', 'Помещение*Площадь;\r\nОбщая Площадь*57.14м2;\r\nПрихожая*7.66м2;\r\nГардеробная*6.5м2;\r\nСанузел*4.24м2;\r\nКухня*7.62м2;\r\nГостиная*27.26м2;', 0, '2018-06-12 00:00:00', '2018-06-15 12:55:20'),
(2, 1, 2, 'Второй этаж', 'Помещение*Площадь;\r\nОбщая Площадь*54.15м2;\r\nСанузел*5.24м2;\r\nСпальня 1*9.94м2;\r\nСпальня 2*15.08м2;\r\nСпальня 3*15.15м2;\r\nБалконы*2.2 и 2.2м2;', 0, '2018-06-12 00:00:00', '2018-06-15 12:55:43'),
(3, 2, 1, 'Первый этаж', 'Помещение*Площадь;\r\nОбщая Площадь*49.59м2;\r\nПрихожая*10.32м2;\r\nСанузел*3.57м2;\r\nКухня*9м2;\r\nГостиная*26.7м2;', 0, '2018-06-12 00:00:00', '2018-06-14 14:05:51'),
(4, 3, 1, 'Первый этаж', 'Помещение*Площадь;\r\nОбщая Площадь*52.5м2;\r\nПрихожая*7.9м2;\r\nСанузел*3.7м2;\r\nКухня*8.1м2;\r\nГостиная*32.8м2;', 0, '2018-06-12 19:19:08', '2018-06-14 14:06:08'),
(5, 1, 3, 'Мансарда', 'Помещение*Площадь;\r\nОбщая Площадь*48.25м2;', 0, '2018-06-14 13:03:54', '2018-06-14 13:03:54'),
(6, 3, 2, 'Второй этаж', 'Помещение*Площадь;\r\nОбщая Площадь*47.5м2;\r\nСанузел*4.6м2;\r\nСпальня 1*11.7м2;\r\nСпальня 2*11.7м2;\r\nСпальня 3*12.7м2;', 0, '2018-06-14 13:12:03', '2018-06-14 14:06:22'),
(7, 3, 3, 'Мансарда', 'Помещение*Площадь;\r\nОбщая Площадь*40.3м2;', 0, '2018-06-14 14:02:03', '2018-06-14 14:02:03'),
(8, 2, 2, 'Второй этаж', 'Помещение*Площадь;\r\nОбщая Площадь*44.42;\r\nСанузел*4.71м2;\r\nГардеробная*8.6м2;\r\nСпальня 1*13.45м2;\r\nСпальня 2*14,38м2;', 0, '2018-06-14 14:08:27', '2018-06-14 14:08:27'),
(9, 2, 3, 'Мансарда', 'Помещение*Площадь;\r\nОбщая Площадь*38.66м2;', 0, '2018-06-14 14:09:38', '2018-06-14 14:09:38');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_blocks_layouts_items`
--

DROP TABLE IF EXISTS `osc_nth_blocks_layouts_items`;
CREATE TABLE IF NOT EXISTS `osc_nth_blocks_layouts_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` int(11) NOT NULL DEFAULT '0',
  `block` int(11) NOT NULL DEFAULT '0',
  `source` varchar(255) DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nth_blocks_layouts_items`
--

INSERT INTO `osc_nth_blocks_layouts_items` (`id`, `ref`, `block`, `source`, `created`, `modified`) VALUES
(12, 1, 0, 'thll_20180614125850365.jpg', '2018-06-14 12:58:51', '2018-06-14 12:58:51'),
(13, 2, 0, 'thll_20180614130256626.jpg', '2018-06-14 13:02:56', '2018-06-14 13:02:56'),
(14, 5, 0, 'thll_20180614130354582.jpg', '2018-06-14 13:03:54', '2018-06-14 13:03:54'),
(15, 4, 0, 'thll_20180614130741410.jpg', '2018-06-14 13:07:41', '2018-06-14 13:07:41'),
(16, 6, 0, 'thll_20180614131203478.jpg', '2018-06-14 13:12:03', '2018-06-14 13:12:03'),
(17, 7, 0, 'thll_20180614140203388.jpg', '2018-06-14 14:02:03', '2018-06-14 14:02:03'),
(18, 3, 0, 'thll_20180614140551426.jpg', '2018-06-14 14:05:51', '2018-06-14 14:05:51'),
(19, 8, 0, 'thll_20180614140827393.jpg', '2018-06-14 14:08:27', '2018-06-14 14:08:27'),
(20, 9, 0, 'thll_20180614140938720.jpg', '2018-06-14 14:09:38', '2018-06-14 14:09:38');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_gal`
--

DROP TABLE IF EXISTS `osc_nth_gal`;
CREATE TABLE IF NOT EXISTS `osc_nth_gal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) DEFAULT NULL,
  `caption` varchar(255) DEFAULT NULL,
  `pos` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп даних таблиці `osc_nth_gal`
--

INSERT INTO `osc_nth_gal` (`id`, `image`, `caption`, `pos`, `block`, `created`, `modified`) VALUES
(1, 'gallery_item.jpg', 'Архитектура в стиле \"старой Европы\"', 0, 0, '2018-06-11 00:00:00', '2018-07-02 17:06:04'),
(2, 'nth_g_20180614141402680.jpg', 'Закрытая территория от автомобилей', 0, 0, '2018-06-11 00:00:00', '2018-07-02 17:06:52'),
(3, 'nth_g_20180614141420680.jpg', 'Детские площадки для разных возрастов', 0, 0, '2018-06-12 17:46:50', '2018-07-02 17:07:22'),
(4, 'nth_g_20180614141436843.jpg', 'Вход и въезд по пропускам', 0, 0, '2018-06-14 14:14:36', '2018-07-02 17:08:34'),
(5, 'nth_g_20180614141445999.jpg', 'Уникальность и внимание к деталям', 0, 0, '2018-06-14 14:14:45', '2018-07-02 17:08:50'),
(6, 'nth_g_20180614141458907.jpg', 'Воплощаем европейские ценности', 0, 0, '2018-06-14 14:14:58', '2018-07-02 17:10:00');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_infoblock1`
--

DROP TABLE IF EXISTS `osc_nth_infoblock1`;
CREATE TABLE IF NOT EXISTS `osc_nth_infoblock1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `content` text,
  `block` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп даних таблиці `osc_nth_infoblock1`
--

INSERT INTO `osc_nth_infoblock1` (`id`, `caption`, `content`, `block`, `created`, `modified`) VALUES
(1, 'Ваш \r\nумный \r\nдом', 'Все экохаусы будут оборудованы системой \"умный дом\" немецкого производителя Larnitec, благодаря ей, вы сможете контролировать:', 0, '2018-06-11 00:00:00', '2018-06-11 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_infoblock1_items`
--

DROP TABLE IF EXISTS `osc_nth_infoblock1_items`;
CREATE TABLE IF NOT EXISTS `osc_nth_infoblock1_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `icon` varchar(255) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nth_infoblock1_items`
--

INSERT INTO `osc_nth_infoblock1_items` (`id`, `name`, `icon`, `created`, `modified`) VALUES
(1, 'Теплые полы и отопление', 'inf1_i_20180613145241792.png', '2018-06-11 00:00:00', '2018-06-11 00:00:00'),
(2, 'Контроль протечки воды', 'ico_water.png', '2018-06-11 00:00:00', '2018-06-11 00:00:00'),
(3, 'Освещение снаружи и внутри дома', 'ico_light.png', '2018-06-11 00:00:00', '2018-06-11 00:00:00'),
(4, 'Система безопасности', 'ico_bell.png', '2018-06-11 00:00:00', '2018-06-11 00:00:00'),
(5, 'Вентиляция и климат-контроль', 'ico_vent.png', '2018-06-11 00:00:00', '2018-06-11 00:00:00'),
(6, 'ТВ <br>Музыка <br>Интернет', 'ico_wifi.png', '2018-06-11 00:00:00', '2018-06-11 00:00:00'),
(7, 'Раскрытие дверей и окон', 'ico_doors.png', '2018-06-11 00:00:00', '2018-06-11 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_infoblock2`
--

DROP TABLE IF EXISTS `osc_nth_infoblock2`;
CREATE TABLE IF NOT EXISTS `osc_nth_infoblock2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `props` text,
  `block` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп даних таблиці `osc_nth_infoblock2`
--

INSERT INTO `osc_nth_infoblock2` (`id`, `caption`, `props`, `block`, `created`, `modified`) VALUES
(1, 'Все \r\nподведено', 'Система умный дом\r\n4 уровня - цоколь, мансарда, 2 жилых этажа\r\nУтепление минеральной ватой\r\nАвтономное отопление\r\nБольшие кухни гостинные\r\nПредусмотрено размещение камина\r\nВъезд по пропускам\r\nМеста для досуга и отдыха\r\nОхрана и видеонаблюдение', 0, '2018-06-11 00:00:00', '2018-06-13 15:09:29');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_intro`
--

DROP TABLE IF EXISTS `osc_nth_intro`;
CREATE TABLE IF NOT EXISTS `osc_nth_intro` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `content` text,
  `image` varchar(255) DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nth_intro`
--

INSERT INTO `osc_nth_intro` (`id`, `caption`, `content`, `image`, `block`, `created`, `modified`) VALUES
(1, 'Экохаусы', '<p>Экохаусы \"Новая Конча-Заспа\" можно смело назвать отдельным миром - экомиром, в котором есть все, что вы могли бы пожелать.&nbsp;&nbsp;</p>\r\n<p>Почему \"Экохаус\"? При разработке концепции, главной задачей проектировщиков было использование только натуральных строительных материалов.</p><p>Вы получаете собственный элегантный дом с двориком, закрытым минипарком и достойными соседями.</p>\r\n<p>Уникальное расположение в нескольких минутах езды от Печерска, гарантирует безупречное транспортное сообщение с любой точкой Киева.</p>\r\n', 'th_intr20180702170018169.jpg', 0, '2018-06-11 00:00:00', '2018-07-02 17:02:28');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_ready_th`
--

DROP TABLE IF EXISTS `osc_nth_ready_th`;
CREATE TABLE IF NOT EXISTS `osc_nth_ready_th` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `area` float NOT NULL DEFAULT '0',
  `block` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп даних таблиці `osc_nth_ready_th`
--

INSERT INTO `osc_nth_ready_th` (`id`, `name`, `area`, `block`, `content`, `created`, `modified`) VALUES
(1, 'Таунхаусы на ул.Кобзаря', 76, 0, 'Двухуровневый таунхаус жилой площадью 76 кв.м. и цокольным этажом 30 кв.м. (общая площадь дома 106 кв.м.) Находится в пос.Ходосеевка, на ул.Кобзаря. Подключены все коммуникации - вода (скважина), свет, отопление - газовый котел. Построены дома из красного кирпича марки М-100.\r\nТаунхаус сочетает в себе все преимущества частного дома: имеет отдельный вход с улицы, собственное парковочное место для авто и отдельный зеленый дворик 30 кв.м. с ландшафтным дизайном. \r\nТерритория вокруг дома ухожена, чисто и зелено, ландшафтный дизайн. В комплексе осталось последних 3 таунхауса.  Стоимость 56000 уе. ', '2018-06-11 00:00:00', '2018-07-02 17:04:23'),
(4, 'Таунхаус в Святопетровском', 124, 0, 'Таунхаус расположен в с.Святопетровское, на ул.Амосова, 24. Дом сдан, подключены все коммуникации. Дом имеет два жилых этажа и мансарду, свой огороженный дворик и паркоместо. Остался только 1 домик. Стоимость 66800 уе.', '2018-06-15 16:34:19', '2018-06-15 16:36:56');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_ready_th_layouts`
--

DROP TABLE IF EXISTS `osc_nth_ready_th_layouts`;
CREATE TABLE IF NOT EXISTS `osc_nth_ready_th_layouts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` int(11) NOT NULL DEFAULT '0',
  `source` varchar(255) DEFAULT NULL,
  `block` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп даних таблиці `osc_nth_ready_th_layouts`
--

INSERT INTO `osc_nth_ready_th_layouts` (`id`, `ref`, `source`, `block`, `created`, `modified`) VALUES
(4, 3, 'thrl_20180613154723409.jpg', 0, '2018-06-13 15:47:23', '2018-06-13 15:47:23'),
(5, 1, 'thrl_20180614164058458.jpg', 0, '2018-06-14 16:40:59', '2018-06-14 16:40:59'),
(6, 1, 'thrl_20180614164141954.jpg', 0, '2018-06-14 16:41:42', '2018-06-14 16:41:42'),
(7, 4, 'thrl_20180615163419176.jpg', 0, '2018-06-15 16:34:19', '2018-06-15 16:34:19'),
(8, 4, 'thrl_20180615163656765.jpg', 0, '2018-06-15 16:36:56', '2018-06-15 16:36:56');

-- --------------------------------------------------------

--
-- Структура таблиці `osc_nth_video`
--

DROP TABLE IF EXISTS `osc_nth_video`;
CREATE TABLE IF NOT EXISTS `osc_nth_video` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_nth_video`
--

INSERT INTO `osc_nth_video` (`id`, `caption`, `video`, `poster`, `time1`, `time2`, `time3`, `time4`, `time5`, `name1`, `name2`, `name3`, `name4`, `name5`, `block`, `created`, `modified`) VALUES
(1, 'Живи в стиле \r\nЭкохаус', 'th_vid20180613180601670.mp4', 'th_post20180612173333697.jpg', 0, 5, 10, 15, 20, 'Престижный пригород', 'Транспортная доступность', 'Камины в домах', 'Безопасность', 'Свой парк', 1, '2018-06-11 00:00:00', '2018-06-15 15:26:18');
...
DROP TABLE IF EXISTS `osc_page_cottages`;
CREATE TABLE IF NOT EXISTS `osc_page_cottages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `details` text,
  `filename` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_page_news`;
CREATE TABLE IF NOT EXISTS `osc_page_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_page_news_cats`;
CREATE TABLE IF NOT EXISTS `osc_page_news_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
...
(7, 'Ваши новые возможности!', 'vashi-novue-vozmozhnosti', '2018-06-15 11:55:49', '2018-06-15 11:55:49');
...
DROP TABLE IF EXISTS `osc_page_news_files`;
CREATE TABLE IF NOT EXISTS `osc_page_news_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(236, 99, 'gall_20180612151502310.jpg', 0, 0, NULL),
(237, 99, 'gall_20180612151503153.jpg', 0, 0, NULL),
(238, 99, 'gall_20180612151503745.jpg', 0, 0, NULL),
(239, 99, 'gall_20180612151504159.jpg', 0, 0, NULL),
(240, 99, 'gall_20180612151504569.jpg', 0, 0, NULL),
(241, 99, 'gall_20180612151505982.jpg', 0, 0, NULL);
...
DROP TABLE IF EXISTS `osc_page_news_items`;
CREATE TABLE IF NOT EXISTS `osc_page_news_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `details` text,
...
(94, 'Предлагаем вашему вниманию коммерческую недвижимость', '<p></p><p style=\"\">Коммерческая недвижимость расположена в построенном 6-ти этажном доме \"Шатель\" (на 100 квартир).&nbsp; Есть варианты фасадных помещений и есть те, которые выходят во двор.&nbsp;</p><p style=\"\">В рамках жилого комплекса уже построены и сданы три 6-ти этажных дома на 180 квартир, готовится к сдаче в эксплуатацию 6-ти секционный девятиэтажный дом \"Лион\" на 460 квартир. Рядом расположены 11 линий таунхаусов на 60 домов, еще 25 домов в процессе строительства.</p><p style=\"\">Коммерческая недвижимость имеет большой потенциал вследствие отсутствия конкуренции и большого спроса на различные объекты бытовой инфраструктуры.</p><br><p></p><table id=\"table55644\"><tbody><tr><td><p></p><p><img src=\"/myprotected/redactor/demo/scripts/uploads/11e9713d49cd64574b8cc75f6e06fa57.jpg\" style=\"width: 377.097px; height: 334px;\"></p><br><p></p></td><td><p><b>Дом \"Шатель\", офис - 32 м2 . Окна во двор.</b></p><p><b></b></p><p><b><b><b>Возможна аренда помещения, ставка 20 уе/кв.м или продажа - 20000 грн/кв.м.&nbsp;</b></b></b></p><p><b><b><b>Отдельный вход, свободная планировка.&nbsp;</b></b></b></p><p><b><b><b>Высокий цокольный этаж.</b></b></b></p></td></tr><tr><td><p><img src=\"/myprotected/redactor/demo/scripts/uploads/7d0a3a218522ed42986c4d7f4760f3cc.jpg\" style=\"width: 355.377px; height: 353px;\"></p><br></td><td><p><b><b>Дом \"Шатель\", о</b>фис - 50,8 м2. Окна на фасад.</b></p><p><b>Возможна аренда помещения, ставка 20 уе/кв.м.&nbsp;</b></p><p><b>Отдельный фасадный вход, свободная планировка.&nbsp;</b></p><p><b>Высокий цокольный этаж.</b></p><p><b>Состояние - после строителей. Есть окна 1х0,6м. Высота потолка - 2,6 м.</b></p><br></td></tr><tr><td><p><img src=\"/myprotected/redactor/demo/scripts/uploads/44324ba5def17d438c5f8390daefcab9.jpg\" style=\"width: 365.098px; height: 686px;\"></p><br></td><td><p><b><b>Дом \"Шатель\", о</b>фис - 75 м2. Окна на фасад.</b></p><p><b>Возможна продажа помещения, 20000 грн/кв.м.&nbsp;</b></p><p><b>Отдельный фасадный вход, свободная планировка.&nbsp;</b></p><p><b>Высокий цокольный этаж.&nbsp;</b></p><p><b>Состояние - после строителей. Есть окна 1х0,6м. Высота потолка - 2,6 м.</b></p><br></td></tr><tr><td><p><img src=\"/myprotected/redactor/demo/scripts/uploads/4565a20575acb7c3a458afd5b9224f79.jpg\" style=\"width: 337.333px; height: 465px;\"></p><br></td><td><p><b><b>Дом \"Шатель\", о</b>фис - 109,2 м2. Окна на фасад.</b></p><p><b>Возможна аренда помещения, ставка 20 уе/кв.м.&nbsp;</b></p><p><b>Отдельный фасадный вход, свободная планировка.&nbsp;</b></p><p><b>Высокий цокольный этаж.&nbsp;</b></p><p><b>Состояние - после строителей. Есть окна 1х0,6м. Высота потолка - 2,6 м.</b></p><br></td></tr></tbody></table><p></p><br><p></p><br><p></p>\r\n', 1, 'artc_20180523125505671.png', 0, 0, '', '', '', '', '', 1, 0, 0, '2018-05-23 00:00:00', '2018-07-03 12:35:05', NULL),
(88, 'Возможности, которые  у вас появляются, став жителем Новой Конча-Заспы', '<p></p><p></p><p></p><p></p><ul><li><b style=\"font-size: 12px;\">                                                              Памятка</b><br></li><li><b style=\"font-size: 12px;\">                       Новые\r\n возможности, которые  у вас появляются,</b><br></li><li><b style=\"font-size: 12px;\">              в\r\nпешей доступности (ну или совсем рядом, в 5-10 минутах езды),</b><br></li><li>                  <b style=\"font-size: 12px;\">став\r\nжильцом  ЖК «Новая Конча-Заспа»,</b></li></ul><p></p>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<p></p><p><img src=\"/myprotected/redactor/demo/scripts/uploads/e95ac693c4c2861f0cd4825b75d1bf34.jpg\" style=\"width: 508.173px; height: 1375px;\"></p><p>И это только базовый\r\nсписок возможностей!!!</p>\r\n\r\nПрисоединяйтесь к нашей дружной семье.<br><p></p><p></p>\r\n', 1, 'artc_20180326151259762.jpg', 7, 0, '', '', '', '', '', 1, 0, 0, '2018-03-26 00:00:00', '2018-06-15 11:56:39', NULL),
...
(97, 'Начинаем продажи в новом доме «Вилар». Акционная цена 12800 грн/м на 10 квартир*! ', '<p>ЖК \"Новая Конча-Заспа\" объявляет о старте продаж квартир в новом строящемся <b>9-ти этажном доме “Вилар”</b>.</p>\r\n\r\n<p>Для дома “Вилар” компания АВМ Девелопмент Групп, вместе с собственным архитектурным бюро, разработали много разнообразных планировок квартир, чтобы любой покупатель мог выбрать жилье на свой вкус и образ жизни.</p>\r\n\r\n<p>Только сейчас на некоторые квартиры* в доме «Вилар» действует акционная цена 12800 грн/м. Срок сдачи дома - 4 кв.2019 г.</p><p>Узнайте больше, чем ценно наше направление и какие уникальные преимущества оно вам даст:</p>\r\n\r\n<p><a href=\"https://n-k-z.com/news/90/\" target=\"_blank\" style=\"font-weight: bold;\">1. Анализ ценовой политики пригорода. Что скрывают застройщики Ирпеня, Бучи, Вишневого</a>&nbsp;(открывается в новом окне)</p>\r\n\r\n<p><a href=\"https://n-k-z.com/news/96/\" target=\"_blank\" style=\"font-weight: bold;\">2. Почему большое внимание мы уделяем социальному окружению. Это безопасность, спокойствие и крепкий сон ваших родных.</a>&nbsp;(открывается в новом окне)</p>\r\n\r\n<p><a href=\"https://n-k-z.com/news/100/\" target=\"_blank\" style=\"font-weight: bold;\">3. Какие новые возможности для вашей семьи даст жизнь в Новой Конча-Заспе.</a>&nbsp;(открывается в новом окне)</p>\r\n\r\n<p style=\"text-align: center;\"><a href=\"https://n-k-z.com/flats/dom-vilar/r1/\">Ознакомится с планировками квартир дома «Вилар» можно тут.</a>\r\n\r\n</p><p></p><p><img src=\"/myprotected/redactor/demo/scripts/uploads/989952e22ae33f1a2bc68542420bd970.jpg\" style=\"width: 849.722px; height: 280px;\"></p><p><br></p><p>* - стоимость 12800 грн/м действует на квартиры в 9 секции дома, на варианты - 2-к - 53,9 кв.м., 1-к - 42,8 кв.м., 2-к - 68,5 кв.м., 3-к - 86,2 кв.м.;</p>\r\n', 1, 'artc_20180601153934205.jpg', 0, 1, '', '', '', '', '', 1, 0, 0, '2018-06-01 00:00:00', '2018-06-18 14:02:20', NULL),
(98, 'Ваши новые возможности! Выбирайте наслаждаться жизнью вместе с ЖК Новая Конча-Заспа!', '<p></p><div>Жизнь в  Новой Конче-Заспе открывает полный  спектр  новых возможностей   для всех членов семьи.  В 10 минутах езды от нас  находится  престижный  конный   клуб семейного типа «Equides Club».</div><div><br></div><div>Здесь    вы сможете заказать уроки верховой езды.  Занятия проводят  тренеры национального уровня  не только из Украины, но и из Германии, Франции, Австралии.</div><div><br></div><div>К вашим услугам роскошный бассейн с видом на сказочное озеро, сауна, хамам, а также тренажерные залы ,  ультрамодная  гольф – зона, рестораны,  отель.</div><div><span style=\"font-size: 12px;\"><br></span></div><div>Все рядом!  Удобно и комфортно! Верните  чистоту и ясность мыслей, найдите правильный жизненный ритм, восстановите энергию и найдите умиротворение и баланс, подарите телу и мыслям релакс, позаботьтесь о красоте Вашего тела.</div><div><br></div><div>Выбирайте наслаждаться жизнью вместе с ЖК Новая Конча-Заспа!</div><div><br></div><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/3WgmyU4DIZg\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen=\"\"></iframe><br>\r\n', 1, 'artc_20180604142833996.jpg', 7, 0, '', '', '', '', '', 1, 0, 0, '2018-06-04 00:00:00', '2018-06-15 11:56:09', NULL),
(99, 'Всем, кто решил инвестировать в Экохаусы, рекомендовано к прочтению!', '<p></p><p><b>Идеальный дом</b></p>\r\n\r\n<p>Всех, кто предпочитает &nbsp;приватный образ жизни, и мечтает о своем\r\nсобственном доме с садом и площадкой для отдыха, в ЖК Новая Конча-Заспа &nbsp;ждут &nbsp;роскошные Экохаусы. <a href=\"https://n-k-z.com/townhouses/\"><span>https://n-k-z.com/townhouses/</span></a> </p>\r\n\r\n<p>Мы тщательно продумали\r\nпланировку каждого из &nbsp;домов, чтобы все\r\nпомещения были максимально полезными для будущих хозяев. Рационально используя\r\nкаждый квадратный метр, мы добились отсутствия неиспользуемых зон, что\r\nделает наши Экохаусы особенно ценными.</p>\r\n\r\n<p>При этом дом &nbsp;и придомовая территория &nbsp;расположены таким образом, чтобы предоставить\r\nжильцам максимальный комфорт и уединение, одновременно обеспечивая великолепный\r\nвид из окна и жилое пространство, наполненное дневным светом.</p>\r\n\r\n<p>Мы также позаботились о\r\nтом, чтобы вы могли формировать свой идеальный дом &nbsp;самостоятельно. &nbsp;Мы\r\nуже&nbsp; включили базовый комплект системы\r\n«Умный дом», сделали ремонт по «чистовую отделку», подвели коммуникации, позаботились\r\nпро возможность установки&nbsp; камина.&nbsp; Дальше, хозяева сами наполняют уютом и\r\nкомфортом свое жилье.</p>\r\n\r\n<p><b>До конца лета действует приятное предложение:&nbsp; Всем, кто присоединится к нашей дружной семье\r\nи выберет Экохаус, мы вручаем </b><b>MacBook</b><b>!</b></p><p></p>\r\n', 1, 'artc_20180612151631813.jpg', 5, 0, '', '', '', '', '', 1, 0, 0, '2018-06-12 00:00:00', '2018-06-12 15:51:49', NULL),
(100, 'Ваши новые возможности! Выбирайте летать вместе с ЖК Новая Конча-Заспа!', '<p></p><div>Поселиться  в престижном классическом пригороде - это значит получить новые возможности, отличные от столичной деловой суматохи.</div><div><br></div><div>Рядом с нами, на холмах Ходосеевки, можно открыть для себя возможность   летать.  Это целое искусство, которое делает человека свободным и насыщает новыми эмоциями.</div><div><br></div><div>Параглайдинг обладает массой преимуществ: доступность, минимум требований, адреналин, потрясающие ощущения. Наполняйте новыми ощущениями свою жизнь.</div><div><br></div><div>И все это рядом с домом!  Удобно и комфортно!</div><div><br></div><div>Выбирайте летать  вместе с ЖК Новая Конча-Заспа!</div><div><br></div><div>                                           <iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/XTiAGQ6QT6g\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen=\"\"></iframe><br></div><p></p>\r\n', 1, 'artc_20180615114803289.jpg', 7, 0, '', '', '', '', '', 1, 0, 0, '2018-06-15 00:00:00', '2018-06-15 11:56:02', NULL),
(101, 'Ваши новые возможности! Выбирайте духовную жизнь вместе с ЖК Новая Конча-Заспа!', '<p></p><div>Поселиться&nbsp; в престижном классическом пригороде - это значит оторваться от суматохи города и больше уделить внимание собственной духовности.</div><div><br></div><div>Новая Конча-Заспа&nbsp; черпает&nbsp; вдохновение в своем историческом и природном наследии. Это место духовности, ведь здесь расположены церкви, храмы и монастыри. Сюда приезжают не только со всей Украины, но и из других стран, чтобы попросить о мире, здоровье, любви и благополучии.&nbsp;</div><div><br></div><div>Совсем рядом находится мужской монастырь Рождества Пресвятой Богородицы и Церковь Святой великомученицы Параскевы. А всего за несколько минут можно добраться и до Свято-Покровского Голосеевского монастыря.&nbsp;</div><div><br></div><div>Выбирайте духовную жизнь вместе с ЖК Новая Конча-Заспа!</div><div><br></div><div>Выбирайте жизнь в престижном классическом пригороде!</div><div><br></div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/XuQ9VW8WbOM\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen=\"\"></iframe><br><p></p>\r\n', 1, 'artc_20180619180207976.jpg', 7, 0, '', '', '', '', '', 1, 0, 0, '2018-06-19 00:00:00', '2018-06-19 18:03:21', NULL);
...
DROP TABLE IF EXISTS `osc_page_program`;
CREATE TABLE IF NOT EXISTS `osc_page_program` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `caption` varchar(255) DEFAULT NULL,
  `content` text,
...
DROP TABLE IF EXISTS `osc_page_program_items`;
CREATE TABLE IF NOT EXISTS `osc_page_program_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
  `caption` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_recall`;
CREATE TABLE IF NOT EXISTS `osc_recall` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `phone` varchar(255) DEFAULT NULL,
  `seen` int(11) NOT NULL DEFAULT '0',
  `created` datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_site_positions`;
...
DROP TABLE IF EXISTS `osc_subscriptions`;
CREATE TABLE IF NOT EXISTS `osc_subscriptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(255) DEFAULT NULL,
  `seen` int(11) NOT NULL DEFAULT '0',
  `created` datetime DEFAULT NULL,
...
--
-- Дамп даних таблиці `osc_subscriptions`
--

INSERT INTO `osc_subscriptions` (`id`, `email`, `seen`, `created`) VALUES
(2, 'oleds777@gmail.com', 0, '2018-07-05 22:03:59');
...
DROP TABLE IF EXISTS `osc_sys_appointments`;
CREATE TABLE IF NOT EXISTS `osc_sys_appointments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `contact` varchar(255) DEFAULT NULL,
  `seen` int(11) NOT NULL DEFAULT '0',
...
(15, 'Сергей', '095-228-77-77', 0, '2018-07-04 13:31:05'),
(16, 'Наталья', '0503912057', 0, '2018-07-06 07:57:11'),
(17, 'Грета', '0502036548', 0, '2018-07-07 05:55:01'),
(18, 'Евгения', '0504160751', 0, '2018-07-09 16:10:01'),
(19, 'Елена', '0503534421', 0, '2018-07-10 09:09:11');
...
DROP TABLE IF EXISTS `osc_sys_bp_cats`;
CREATE TABLE IF NOT EXISTS `osc_sys_bp_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
...
(3, 'ЖК Vlasna', 'zhk-vlasna', 'Квартиры от 524 400 грн', 'https://n-k-z.com/flats/proekt-vlasna/r1/', 0, '2018-01-15 21:29:46', '2018-06-13 18:17:45');
...
DROP TABLE IF EXISTS `osc_sys_bp_entries`;
CREATE TABLE IF NOT EXISTS `osc_sys_bp_entries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_sys_bp_photos`;
CREATE TABLE IF NOT EXISTS `osc_sys_bp_photos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_sys_contact_form`;
CREATE TABLE IF NOT EXISTS `osc_sys_contact_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_sys_docs`;
CREATE TABLE IF NOT EXISTS `osc_sys_docs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cat` int(11) NOT NULL DEFAULT '0',
  `source` varchar(255) DEFAULT NULL,
  `block` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `osc_sys_doc_cats`;
CREATE TABLE IF NOT EXISTS `osc_sys_doc_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `icon` varchar(255) DEFAULT NULL,
...
(13, 'Документы на землю', 'dic_20180110013945808.png', NULL, 'dokumentu-na-zemlyu', 0, NULL, '2018-07-03 16:12:30'),
...
DROP TABLE IF EXISTS `osc_sys_env_coords`;
CREATE TABLE IF NOT EXISTS `osc_sys_env_coords` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
  `type` int(11) NOT NULL DEFAULT '1',
...
DROP TABLE IF EXISTS `osc_sys_events`;
CREATE TABLE IF NOT EXISTS `osc_sys_events` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_sys_flats`;
CREATE TABLE IF NOT EXISTS `osc_sys_flats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `osc_sys_flats_layouts_ibfk_1` (`house_id`),
  KEY `room_id` (`room_id`)
...
DROP TABLE IF EXISTS `osc_sys_flats_layouts`;
CREATE TABLE IF NOT EXISTS `osc_sys_flats_layouts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(88, 55, 'flyts_20180613164658700.jpg', 0, '2018-06-13 16:46:58', '2018-06-13 16:46:58'),
(89, 56, 'flyts_20180613164828920.jpg', 0, '2018-06-13 16:48:28', '2018-06-13 16:48:28'),
(90, 57, 'flyts_20180613164928462.jpg', 0, '2018-06-13 16:49:28', '2018-06-13 16:49:28'),
(91, 58, 'flyts_20180613165132103.jpg', 0, '2018-06-13 16:51:33', '2018-06-13 16:51:33'),
(92, 59, 'flyts_20180613165418234.jpg', 0, '2018-06-13 16:54:18', '2018-06-13 16:54:18'),
(93, 60, 'flyts_20180613165456642.jpg', 0, '2018-06-13 16:54:56', '2018-06-13 16:54:56'),
(94, 61, 'flyts_20180613165534725.jpg', 0, '2018-06-13 16:55:34', '2018-06-13 16:55:34'),
(95, 62, 'flyts_20180613165723264.jpg', 0, '2018-06-13 16:57:23', '2018-06-13 16:57:23'),
(96, 63, 'flyts_20180613165754552.jpg', 0, '2018-06-13 16:57:54', '2018-06-13 16:57:54');
...
DROP TABLE IF EXISTS `osc_sys_houses`;
CREATE TABLE IF NOT EXISTS `osc_sys_houses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_sys_house_gal`;
CREATE TABLE IF NOT EXISTS `osc_sys_house_gal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `house_id` int(11) NOT NULL DEFAULT '0',
  `source` text,
  `type` int(11) NOT NULL DEFAULT '1',
...
DROP TABLE IF EXISTS `osc_sys_house_slides`;
CREATE TABLE IF NOT EXISTS `osc_sys_house_slides` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `house_id` int(11) NOT NULL DEFAULT '0',
  `source` text,
  `type` int(11) NOT NULL DEFAULT '1',
...
DROP TABLE IF EXISTS `osc_sys_manager`;
CREATE TABLE IF NOT EXISTS `osc_sys_manager` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caption` varchar(255) DEFAULT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `details` text,
...
DROP TABLE IF EXISTS `osc_sys_manager_menu`;
CREATE TABLE IF NOT EXISTS `osc_sys_manager_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `link` varchar(255) DEFAULT NULL,
  `block` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `osc_sys_projects`;
CREATE TABLE IF NOT EXISTS `osc_sys_projects` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_sys_rooms`;
CREATE TABLE IF NOT EXISTS `osc_sys_rooms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `house_id` int(11) DEFAULT NULL,
  `order_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) DEFAULT NULL,
  ...
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `osc_sys_rooms_ibfk_1` (`house_id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `osc_tables_info`;
...
DROP TABLE IF EXISTS `osc_th_blocks`;
CREATE TABLE IF NOT EXISTS `osc_th_blocks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_th_blocks_items`;
CREATE TABLE IF NOT EXISTS `osc_th_blocks_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `source` varchar(255) DEFAULT NULL,
  `block` int(11) NOT NULL DEFAULT '0',
  `ref` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `osc_th_floors`;
CREATE TABLE IF NOT EXISTS `osc_th_floors` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `alias` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_th_gal`;
CREATE TABLE IF NOT EXISTS `osc_th_gal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `source` varchar(255) DEFAULT NULL,
  `caption` varchar(255) DEFAULT NULL,
  `sub_caption` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_th_layouts`;
CREATE TABLE IF NOT EXISTS `osc_th_layouts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `layout_name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_th_layouts_items`;
CREATE TABLE IF NOT EXISTS `osc_th_layouts_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref_id` int(11) NOT NULL DEFAULT '0',
  `block` int(11) NOT NULL DEFAULT '0',
  `source` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `osc_th_page`;
CREATE TABLE IF NOT EXISTS `osc_th_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_th_tabs`;
CREATE TABLE IF NOT EXISTS `osc_th_tabs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `osc_total_config`;
...
DROP TABLE IF EXISTS `osc_transfer`;
CREATE TABLE IF NOT EXISTS `osc_transfer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `phone` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `viewed` int(1) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `osc_translate`;
CREATE TABLE IF NOT EXISTS `osc_translate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
  `en` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `osc_users` (
  ...
  `order_id` int(5) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='System Administrators';
